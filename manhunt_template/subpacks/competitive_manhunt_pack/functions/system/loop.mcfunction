...
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=599}] {"rawtext":[{"text":"§7You died! Respawning in 30 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=300}] {"rawtext":[{"text":"§7Respawning in 15 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=200}] {"rawtext":[{"text":"§7Respawning in 10 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=100}] {"rawtext":[{"text":"§7Respawning in 5 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=80}] {"rawtext":[{"text":"§7Respawning in 4 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=60}] {"rawtext":[{"text":"§7Respawning in 3 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=40}] {"rawtext":[{"text":"§7Respawning in 2 seconds!"}]}
execute @a[tag=host,scores={settings_state=2}] ~~~ tellraw @a[tag=hunter,scores={spawn_time=20}] {"rawtext":[{"text":"§7Respawning in 1 second!"}]}
...
execute @a[tag=host,scores={settings_state=2,speed_alive=1..,hunt_alive=1..}] ~~~ execute @a[tag=speedrunner,l=0,lm=0] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§cHunter(s) won the game!"}]}
...
execute @a[tag=host,scores={settings_state=2,speed_alive=1..,hunt_alive=1..,timer=..0}] ~~~ tellraw @a {"rawtext":[{"text":"§eSpeedrunner won the game!"}]}
...
execute @a[tag=host,scores={settings_state=2,speed_alive=1..,hunt_alive=0}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§cAll hunters left the game! Speedrunner won!"}]}
...
execute @a[tag=host,scores={settings_state=2,speed_alive=0,hunt_alive=1..}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§cSpeedrunner left the game! Hunter(s) won!"}]}
