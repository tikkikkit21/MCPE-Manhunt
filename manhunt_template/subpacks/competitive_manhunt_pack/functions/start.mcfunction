...
execute @a[tag=host,scores={players=2..,applytrack=1..}] ~ ~ ~ execute @r[tag=track] ~~~ tag @a add speedrunner
execute @a[tag=host,scores={players=2..,applytrack=0}] ~ ~ ~ tag @r add speedrunner
execute @a[tag=host,scores={players=2..}] ~ ~ ~ scoreboard players set @a[tag=hunter] progress 1
execute @a[tag=host,scores={players=2..}] ~ ~ ~ tag @a[tag=!speedrunner] add hunter
